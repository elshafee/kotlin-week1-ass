...
class HuaweiBrand(name: String) : Mobile() {
    val name = name
    ...
    override fun OperatSys(index: Int) {
        when (x) {
            in 0..9 -> println("Operating System is : Android")
            else -> println("Operating System is : HarmonyOS")
        }
    }
    ...
    override fun OPVersion(index: Int) {
        when (x) {
            in 0..9 -> println("Current Software Version is: 8")
            else -> println("Current Software Version is: 12")
        }
    ...
    override fun SecurityOp(index: Int) {
        when (x) {
            in 0..9 -> println("Security Option is : TouchID")
            else -> println("Security Option is : FacID & TouchID")
        }
    }
    ...
    override fun BrandName(index: Int) {
        println("Brand Name is Huawei")
    }

    override fun ExSupport(index: Int) {
        when (x) {
            in 0..9 -> println("Latest OS version Support:  NO")
            else -> println("Latest OS version Support:  yes")
        }
